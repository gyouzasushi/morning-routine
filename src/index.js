...
let offsetLeft = 30;
let offsetRight = 0;
function createrRoutineView(str, id, len) {
...
function addArrow(s, t) {
    ...
    for (const [s, t] of leftEdges)
        routineField.appendChild(createArrowLeft(s, t));
    for (const [s, t] of rightEdges)
        routineField.appendChild(createArrowRight(s, t));
}
addButton.onclick = () => {
